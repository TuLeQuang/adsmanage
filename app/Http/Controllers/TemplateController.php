...
class TemplateController extends Controller {
	...
	// 		'Active' => 'required',
	// 	]);
	// 	$create = template::create($request->all());
	...
	// 	tempalte::find($id)->edit();
	// 	return view('admin.templates.template_detail');
	// }
	...
	// 	$edit = template::find($id)->update($request->all());
	...
	// public function showVuetemplate() {
	// 	return view('fontend.vue-template');
	// }
	...
	public function getActive(Request $request, $id) {
		...
		if ($templates->active == 1) {$templates->active = 0;} else {
			$templates->active = 1;
		}
