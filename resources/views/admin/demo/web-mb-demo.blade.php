...
<head>
  <meta charset="utf-8">
  <title>create demo Adx mobi</title>
    ...
    function exportLink(){
        ...
        $.ajax({
            ...
            if(result=='error not temp'){
                ...
                console.log(result);
                var url=(location.protocol+location.port+'//'+location.hostname+'/link/'+result);
