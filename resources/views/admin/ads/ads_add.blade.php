...
@section('script')
  ...
  <script type="text/javascript">
      ...
      var div_script= '<div id="save-ads" style="display: none;float: left; position: absolute;left: 475px;top: 0px;"><button type="button" @click="exportScript()" :disabled="errors.any()" class="btn btn-primary">Save Ads</button><p id ="script"></p></div>';
      ...
      var vm = new Vue({
          ...
          +'<div id="ads" style="display:inline-block;margin-left: 50px;"><form action="http://template.localhost/admin/ads" method="post">'+js_adsToken+'<label style="color: red;display: none ;margin-left: 30px"  id="errorsMessages"> </label><table><tr><td><label for="">Ads Name: </label></td><td><input type="text" id="ads_name" name="txtAdsName" class="input-item form-control" required></td></tr><tr><td><label for="">Ads Brand: </label></td><td><input type="text" id="ads_brand" name="txtAdsBrand" class="input-item form-control" required></td></tr></table><input type="text" id="ads_data" name="txtAdsData" style="display: none"><input type="text" id="template_id" name="txtTemplateId" style="display: none"><button type="submit" id="save-ads" @click="exportScript()" :disabled="errors.any()" class="btn btn-primary" style="margin-left: 130px;margin-top: 10px">Save Ads</button></form></div>'
          +'</div>',
          methods:{
